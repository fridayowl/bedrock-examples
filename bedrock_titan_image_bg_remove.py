...
def main(input_s3_url, output_s3_url):
    ...
    try:
        ...
        print(f"Finished background removal using Amazon Titan Image Generator V2 model {model_id}.")
...
def remove_background(model_id, body):
    """
    Remove the background from an image using Amazon Titan Image Generator V2 model.
    ...
    """
    logger.info("Removing background with Amazon Titan Image Generator V2 model %s", model_id)
    ...
    try:
        ...
        logger.info("Successfully removed background with Amazon Titan Image Generator V2 model %s", model_id)
        return image_bytes
